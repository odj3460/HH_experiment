...
/*
	Global Variables
*/
std::string g_com_port 			= "/dev/ttyUSB1";	// default serial device name...
int 		g_baud_rate 		= 230400;			// default baud-rate serial device...
...
int main(int argc, char** argv)
{
	...
	ros::Publisher rft_publisher = nh.advertise<geometry_msgs::WrenchStamped>("RFT_FORCE", 100);
	...
	while(ros::ok())
	{
		...
		// ROS_INFO("Main loop iteration at time: %f", ros::Time::now().toSec());
